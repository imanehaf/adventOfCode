object tsu_day07 extends App {
  //TODO: implement recursive solution for pt2
...
//  var tot = Array("1",Array[String]())
//  val tmp = findstuff(color)
//  def findstuff(k:String): Array[Any] ={
//    val child = fdata.getOrElse(k.trim, Array[List[String]]())
//    if (child.nonEmpty) {
//      child.flatMap{ c =>
//        val nx = Array(c.head, findstuff(c.last))
//        tot = Array(tot(0), tot(1) +: nx)
//        nx
//      }
//    }else{
//      Array[Any]()
